...
public class UserNetworkingStrategy implements IStrategy {
	
	private static final String TAG = UserNetworkingStrategy.class.getSimpleName();
	...
	public UserNetworkingStrategy() {
	}
	
	public UserNetworkingStrategy(ServiceEvent event, List<ServiceData> data, 
