...
public class AnswerNetworkingStrategy implements IStrategy {
	
	private static final String TAG = AnswerNetworkingStrategy.class.getSimpleName();
	...
	public AnswerNetworkingStrategy() {
	}
	
	public AnswerNetworkingStrategy(ServiceEvent event, List<ServiceData> data, 
